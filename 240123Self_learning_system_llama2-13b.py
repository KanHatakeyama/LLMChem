...
# project path
project_dir = f"results/projects/240122llama2_13b_self_reasoning_{n_GPT_reasoning}"

# reasoning options
error_threshold = 25  # if abolute error is smaller than this, add to training data
