...
# project path
project_dir = f"results/projects/240124mixtral_self_reasoning_err5_{n_GPT_reasoning}"

# reasoning options
error_threshold = 5  # if abolute error is smaller than this, add to training data
